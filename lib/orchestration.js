...
CALIBRATION: Score 3 = good/solid creative work. Reserve 1-2 for content that fundamentally fails creatively. Most competent content should score 3-4.

Respond in this exact format:
CREATIVE_SCORE: X.X/5
CREATIVE_VERDICT: PASS or NEEDS_POLISH (PASS if score >= 3.5, NEEDS_POLISH if below 3.5)
...
export function parseMuseQAVerdict(output) {
  ...
  // Score-based verdict override: 3.5+ always passes, below 3.5 always needs polish
  // This prevents LLM from saying NEEDS_POLISH on a 3.8 score
  let verdict
  if (score !== null) {
    verdict = score >= 3.5 ? 'PASS' : 'NEEDS_POLISH'
  } else {
