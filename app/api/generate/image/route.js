// Image Generation API — DALL-E 3 visual creation for Songfinch content
...
export async function POST(request) {
  ...
  try {
    ...
    await addActivity({
      ...
      'Details': `DALL-E 3 ${preset} (${result.size}). Territory: ${territory || 'N/A'}. Prompt: ${imagePrompt.substring(0, 200)}`,
